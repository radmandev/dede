...
import { Trash2, Zap, ZapOff, Server, RefreshCw, Link2, AlertTriangle, CheckCircle2, LayoutPanelLeft } from "lucide-react";
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          {accounts.length > 0 && (
            <Button
              ...
              onClick={rebindPlacements}
              disabled={rebinding}
            >
              <LayoutPanelLeft className={`h-3.5 w-3.5 ${rebinding ? "animate-spin" : ""}`} />
              {rebinding ? "Rebinding…" : "Rebind Placements"}
            </Button>
          )}
        </div>
